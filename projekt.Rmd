...
```{r graf1, echo=FALSE, fig.align='center', fig.cap='Države ki imajo največji delez BDP-ja ki ga predstavlja turizem (%)'}
...
```{r graf2, echo=FALSE, fig.align='center', fig.cap='Države,ki imajo najmanjši delez BDP-ja ki ga predstavlja turizem (%)'}
...
```{r graf3, echo=FALSE, fig.align='center', fig.cap='Države,ki imajo največ zaposlenih v turizmu (%)'}
ggplot(data=najvec_zaposlenih , aes(x=Drzava,y=`Število zaposlenih v turizmu(%)`))+ geom_bar(stat = "identity",aes(fill=Drzava))
```


```{r graf4, echo=FALSE, fig.align='center', fig.cap='Države,ki imajo najmanj zaposlenih v turizmu (%)'}
